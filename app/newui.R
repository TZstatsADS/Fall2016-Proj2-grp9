...
TimeRange <- c(
  "6:00-7:00" = "t1",
  "7:00-8:00" = "t2", "8:00-9:00" = "t3", "9:00-10:00" = "t4", 
  "10:00-11:00" = "t5", "11:00-12:00" = "t6", "12:00-13:00" = "t7",
  "13:00-14:00" = "t8", "14:00-15:00" = "t9", "15:00-16:00" = "t10",
  "16:00-17:00" = "t11", "17:00-18:00" = "t12", "18:00-19:00" = "t13",
  "19:00-20:00" = "t14", "20:00-21:00" = "t15", "21:00-22:00" = "t16"
)
                   ...
                   tabPanel("Citi Bike Map",
                            ...
                            div(class="outer",
                                ...
                                absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
                                              ...
                                              selectInput("TimeRange", "Time Range of the day", TimeRange, selected = "8:00-9:00"),                                            
                                            
                                              ### 2. second option: Current location
                                              textInput("address1", "Your Location", value = "350 5th Ave, New York, NY", width = NULL, placeholder = NULL),
                                              actionButton("submit","Mark",icon = icon("calendar")),
                                              
                                              ### 3. third option: Location for the destination
                                              textInput("address2", "Destination", value = "Columbia University, New York, NY", width = NULL, placeholder = NULL),
                                              actionButton("submit","Mark",icon = icon("calendar")),
                                              ...
                                              helpText("Check to show estimated time"),
                                              #actionButton("submit","Show estimated time"),
                                              checkboxInput("estimatedtime", "Show estimated time")
...
# address1
# address2
# estimatedtime: need to be calculated
